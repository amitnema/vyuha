...
public class VyuhaAllTest {
    ...
    public Object[][] dbPermCheck() {
        return new Object[][]{new Object[]{new int[]{3, 4, 1, 2}, 1},
                new Object[]{new int[]{5, 6, 8, 7, 4, 9, 3, 2}, 0}, new Object[]{new int[]{1, 1, 3}, 0}};
    ...
    public void testFrogRiverOne(final int x, final int[] a, final int expected) {
        assertEquals(frogRiverOne.findFrogRiverOne(x, a), expected);
